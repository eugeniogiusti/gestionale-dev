...
return [
    ...
    // Follow-up
    'followup' => [
        'section_title' => '潜在客户跟进',
        'add' => '添加跟进',
        'modal_title' => '新跟进',
        'modal_title_edit' => '编辑跟进',
        'empty' => '没有跟进记录',
        'created' => '跟进已保存',
        'updated' => '跟进已更新',
        'deleted' => '跟进已删除',
        'add_to_calendar' => '添加到谷歌日历',
        'confirm_delete' => '删除此跟进？',
        'type' => '类型',
        'contacted_at' => '联系日期',
        'note' => '备注',
        'note_placeholder' => '简要描述联系情况...',
        'type_call' => '电话',
        'type_email' => '邮件',
        ...
        'validation' => [
            ...
            'type_invalid' => '无效类型',
            'contacted_at_required' => '联系日期为必填项',
            'contacted_at_invalid' => '无效日期',
        ],
    ],
];