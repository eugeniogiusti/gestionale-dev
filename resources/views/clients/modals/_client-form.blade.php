                    ...
                    <div class="px-6 py-4 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                <div>
                                    ...
                                    <select name="phone_prefix" x-model="formData.phone_prefix"
                                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500">
                                        <option value="">{{ __('clients.phone_prefix') }}</option>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="billing_province" x-model="formData.billing_province" placeholder="{{ __('clients.placeholder.billing_province') }}"
                                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500">
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('clients.hint.billing_province') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="billing_country" x-model="formData.billing_country" placeholder="{{ __('clients.placeholder.billing_country') }}" maxlength="2"
                                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500">
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('clients.hint.billing_country') }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <input type="text" name="billing_recipient_code" x-model="formData.billing_recipient_code" placeholder="{{ __('clients.placeholder.billing_recipient_code') }}" maxlength="7"
                                           class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500">
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('clients.hint.billing_recipient_code') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="activeTab === 'web'" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="notes" x-model="formData.notes" rows="6" placeholder="{{ __('clients.placeholder.notes') }}"
