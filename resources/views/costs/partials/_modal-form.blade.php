            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl" @click.stop>
                ...
                <form method="POST"
                    ...
                    <div class="px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-2">
                        ...
                        <button type="submit"
                                :disabled="!formData.amount || !formData.paid_at || !formData.type"
                                :class="(!formData.amount || !formData.paid_at || !formData.type) ? 'bg-gray-300 dark:bg-gray-600 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700'"
