...
<div class="flex items-center gap-2 shrink-0">
    <button
        ...
        data-payload="{{ json_encode(array_merge($project->toFormPayload(['client_name' => $project->client?->name]), ['_back' => 'show']), JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) }}"
