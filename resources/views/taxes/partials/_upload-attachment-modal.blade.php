...
<div x-data="taxAttachmentModal()"
     @upload-tax-attachment.window="openUpload($event.detail)"
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl" @click.stop>
                ...
                <form method="POST"
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-gray-400 dark:hover:border-gray-500 transition">
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                    <label class="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-amber-600 hover:text-amber-500 focus-within:outline-none">
                                    ...
                                    <p class="pl-1">{{ __('ui.or_drag') }}</p>
                                </div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('taxes.attachment_mimes') }}</p>
                                <p x-show="fileName"
                                   x-text="fileName"
                                   class="text-sm font-medium text-amber-600 dark:text-amber-400 mt-2"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                        ...
                        <button type="submit"
                                :disabled="!fileName"
                                :class="fileName ? 'bg-amber-600 hover:bg-amber-700' : 'bg-gray-400 cursor-not-allowed'"
